 ...
 */
const Blocktron = require('../src/lib/blocktron');
...
/**
 * Use an invalid chain 
 */
let blockchainInvalid = {
    "chain": [{
            "index": 1,
            "timeStamp": 1531318682438,
            "transactions": [],
        ...
        },
        {
            ...
            "nonce": 53957,
            "hash": "0000f5dff3d8a3853c588a0ae0deca89sdf1ad4ad72c677180c95ff9bf935cdba34",
            "previousHash": "00007e02d5c51ea841ddabe42380c00b319d053d1fe974e1378d662dae20d8bf"
        },
        {
            "index": 5,
...
describe('Given a valid blockchain data', () => {
    test('It should validate the chain and return -> true', (done) => {
        let isValid = blocktron.isChainValid(blockchainValid.chain);
        expect(isValid).toBe(true);
        done();
    });
});

describe('Given an invalid blockchain data', () => {
    test('It should validate the chain and return -> false', (done) => {
        let isValid = blocktron.isChainValid(blockchainInvalid.chain);
